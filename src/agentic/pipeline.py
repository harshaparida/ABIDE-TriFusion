...
def run_pipeline(data_dir: str, config: Dict[str, Any] = None, verbose: bool = True) -> Dict[str, Any]:
    ...
    init_state = {
        ...
        "fc_search_ks": [1500, 3000, 5000, 8000],
        "fc_search_strategies": ["prop", "mst_prop"],
        "embed_method": "ae",
        "ae_dim": 384,
        "ae_epochs": 40,
        "concat_edges_count": 2000,
    }
    ...
    if verbose:
        print("Pipeline: running multimodal deep agent (TransformerFusion)", flush=True)
    try:
